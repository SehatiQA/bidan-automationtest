...
'Tap tombol sudah'
Mobile.tap(findTestObject('Onboarding/Tombol Sudah'), 0, FailureHandling.CONTINUE_ON_FAILURE)

'wait'
Mobile.delay(3, FailureHandling.CONTINUE_ON_FAILURE)

'Check halaman login tampil'
Mobile.verifyElementExist(findTestObject('Login/Tombol Masuk'), 0, FailureHandling.CONTINUE_ON_FAILURE)
